...
/* harmony import */ var _mixins_Loading__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../../mixins/Loading */ "./resources/js/mixins/Loading.js");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  name: "Employee",
  mixins: [_mixins_paginationMixin__WEBPACK_IMPORTED_MODULE_0__.paginationMixin, _mixins_Loading__WEBPACK_IMPORTED_MODULE_1__.loadingMixin],
  data: function data() {
    return {
      title: "Employees",
      form: {
  ...
  computed: {
    ...
    roles: function roles() {
      var p = this.$store.state.general_module.all_roles;
      return p;
    }
  },
  methods: {
                      ...
                      _c("div", { staticClass: "form-group" }, [
                        ...
                        _c(
                          "select",
                          {
                            ...
                            class: {
                              "is-invalid":
                                _vm.submitted && _vm.$v.form.company_id.$error
                            },
                            attrs: { id: "" },
                            on: {
                        ...
                        _vm.submitted && _vm.$v.form.company_id.$error
                          ? _c("div", { staticClass: "invalid-feedback" }, [
                              !_vm.$v.form.company_id.required
                                ? _c("span", [_vm._v("Company is required")])
                                : _vm._e()
                            ])
                          : _vm._e()
                      ]),
                      ...
                      _c("div", { staticClass: "form-group" }, [
                        ...
                        _c(
                          "select",
                          {
                            ...
                            class: {
                              "is-invalid":
                                _vm.submitted && _vm.$v.form.role_id.$error
                            },
                            attrs: { id: "" },
                            on: {
                              change: function($event) {
                        ...
                        _vm.submitted && _vm.$v.form.role_id.$error
                          ? _c("div", { staticClass: "invalid-feedback" }, [
                              !_vm.$v.form.role_id.required
                                ? _c("span", [_vm._v("Role is required")])
                                : _vm._e()
                            ])
                          : _vm._e()
                      ]),
